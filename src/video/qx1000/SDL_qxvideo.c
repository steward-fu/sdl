...
static int QX1000_Available(void)
{
    debug("%s\n", __func__);
    return 1;
}
...
static void QX1000_VideoQuit(_THIS)
{
    debug("%s\n", __func__);
}
...
static SDL_VideoDevice* QX1000_CreateDevice(int devindex)
{
    ...
    device->VideoInit = QX1000_VideoInit;
    device->ListModes = QX1000_ListModes;
    device->SetVideoMode = QX1000_SetVideoMode;
    device->CreateYUVOverlay = NULL;
    device->SetColors = QX1000_SetColors;
    device->UpdateRects = QX1000_UpdateRects;
    device->VideoQuit = QX1000_VideoQuit;
    device->AllocHWSurface = QX1000_AllocHWSurface;
    device->CheckHWBlit = QX1000_CheckHWBlit;
    device->FillHWRect = NULL;
    device->SetHWColorKey = NULL;
    device->SetHWAlpha = NULL;
    device->LockHWSurface = QX1000_LockHWSurface;
    device->UnlockHWSurface = QX1000_UnlockHWSurface;
    device->FlipHWSurface = QX1000_FlipHWSurface;
    device->FreeHWSurface = QX1000_FreeHWSurface;
...
VideoBootStrap QX1000_bootstrap = {"qx1000", "SDL QX1000 video driver", QX1000_Available, QX1000_CreateDevice};
